package uk.gov.onelogin.criorchestrator.features.handback.internal.component.facescanlimitreached.mobile
...
import uk.gov.onelogin.criorchestrator.features.handback.internal.facescanlimitreached.mobile.FaceScanLimitReachedMobileConstants
...
class FaceScanLimitReachedMobileScreenAnalyticsTest {
    ...
    fun `when screen starts, it tracks analytics`() {
        val expectedEvent =
            ViewEvent
                .Screen(
                    id = HandbackScreenId.FaceScanLimitReachedMobile.rawId,
                    name = context.getString(FaceScanLimitReachedMobileConstants.titleId),
    ...
    fun `when continue to gov uk website is clicked, it tracks analytics`() {
        ...
        val expectedEvent =
            TrackEvent
                .Button(
                    text = context.getString(FaceScanLimitReachedMobileConstants.buttonId),
                    params = HandbackAnalytics.requiredParameters,
                ).asLegacyEvent()
