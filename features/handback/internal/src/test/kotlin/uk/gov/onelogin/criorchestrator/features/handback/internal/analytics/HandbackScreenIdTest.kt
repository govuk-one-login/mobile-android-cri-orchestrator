...
class HandbackScreenIdTest {
    ...
    fun `when screens are displayed, the IDs are set correctly`() {
        ...
        assertEquals("8d09e79f-f242-48c8-a456-4f302c23e6cb", HandbackScreenId.ConfirmAbortToDesktopWeb.rawId)
        assertEquals("8d09e79f-f242-48c8-a456-4f302c23e6cb", HandbackScreenId.ConfirmAbortReturnToDesktopWeb.rawId)
    }
}
