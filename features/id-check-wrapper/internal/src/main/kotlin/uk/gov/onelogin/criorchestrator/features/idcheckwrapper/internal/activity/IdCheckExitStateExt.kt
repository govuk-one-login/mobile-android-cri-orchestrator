...
fun IdCheckSdkExitState.hasAbortedSession(): Boolean = when (this) {
...
fun IdCheckSdkExitState.isSuccess(): Boolean = when (this) {
    IdCheckSdkExitState.HappyPath,
    -> true
...
fun IdCheckSdkExitState.isLimitReached(): Boolean = when (this) {
...
fun IdCheckSdkExitState.noValidSession(): Boolean = when (this) {
