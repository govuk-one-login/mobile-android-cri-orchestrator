...
data class IdCheckSdkActivityResultContractParameters(
    ...
    fun toActivityResultContract() =
        IdCheckSdkActivityResultContract(
            ...
            logger = logger,
            createIntentBehaviour = {
                IdCheckSdkActivityResultContract.defaultCreateIntentBehaviour(
                    it,
                )
            },
            parseResultBehaviour = { IdCheckSdkActivityResultContract.defaultParseResultBehaviour() },
        )
}
