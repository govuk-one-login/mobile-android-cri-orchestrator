package uk.gov.onelogin.criorchestrator.features.documentselection.internal.analytics
...
class DocumentSelectionAnalyticsTest {
    ...
    companion object {
        @StringRes
        val buttonText = R.string.documentselection_passport_readmore_button
    }
