package uk.gov.onelogin.criorchestrator.features.selectdoc.internal.unit.drivinglicence.confirm
...
import uk.gov.onelogin.criorchestrator.features.selectdoc.internal.drivinglicence.confirm.ConfirmDrivingLicenceAction
import uk.gov.onelogin.criorchestrator.features.selectdoc.internal.drivinglicence.confirm.ConfirmDrivingLicenceState
...
class ConfirmDrivingLicenceViewModelTest {
    ...
    @Test
    fun `it emits an initial state`() = runTest {
    ...
    @Test
    fun `when confirm is pressed, navigatae to SyncIdCheck screen`() = runTest {
        viewModel.action.test {
            viewModel.onConfirmClick()
            verify(analyticsLogger)
                .trackButtonEvent(
