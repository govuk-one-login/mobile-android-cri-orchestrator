package uk.gov.onelogin.criorchestrator.features.selectdoc.internal.unit.brp.confirm
...
import uk.gov.onelogin.criorchestrator.features.selectdoc.internal.brp.confirm.ConfirmBrpAction
...
class ConfirmBrpViewModelTest {
    ...
    @Test
    fun `when confirm is pressed, navigate to SyncIdCheck screen`() = runTest {
        viewModel.action.test {
            viewModel.onConfirmClick()
